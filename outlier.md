...
Overall, this approach provides a robust and accurate method for detecting outliers in datasets that utilize landmarks data.
...
In the data analysis, we found that all x, y are between [-1,1]。
